...
namespace Services.OrderAPI.Migrations
{
    ...
    [Migration("20241121123707_M_Change_CustomerID_Type")]
    partial class M_Change_CustomerID_Type
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Services.OrderAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "123 Main St",
                            Customer_ID = "101",
                            Datetime = new DateTime(2024, 11, 11, 19, 37, 5, 783, DateTimeKind.Local).AddTicks(8400),
                            Discount_amount = 5m,
                        ...
                        new
                        {
                            ...
                            Coupon_Code = 2001,
                            Customer_ID = "102",
                            Datetime = new DateTime(2024, 11, 16, 19, 37, 5, 783, DateTimeKind.Local).AddTicks(8421),
                            Discount_amount = 10m,
                            OrderStatus = "Pending",
                            Total = 200m
                        },
                        new
                        {
                            ...
                            Address = "789 Oak St",
                            Customer_ID = "103",
                            Datetime = new DateTime(2024, 11, 21, 19, 37, 5, 783, DateTimeKind.Local).AddTicks(8423),
                            Discount_amount = 0m,
                            OrderStatus = "Shipped",
                            Total = 250m
                        });
