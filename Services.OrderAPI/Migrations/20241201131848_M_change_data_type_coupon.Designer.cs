...
namespace Services.OrderAPI.Migrations
{
    ...
    [Migration("20241201131848_M_change_data_type_coupon")]
    partial class M_change_data_type_coupon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Services.OrderAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "123 Main St",
                            Customer_ID = "101",
                            Datetime = new DateTime(2024, 11, 21, 20, 18, 47, 834, DateTimeKind.Local).AddTicks(6936),
                            Discount_amount = 5m,
                        ...
                        new
                        {
                            ...
                            Coupon_Code = "2001",
                            Customer_ID = "102",
                            Datetime = new DateTime(2024, 11, 26, 20, 18, 47, 834, DateTimeKind.Local).AddTicks(6952),
                            Discount_amount = 10m,
                            OrderStatus = "Pending",
                            Total = 200m
                        },
                        new
                        {
                            ...
                            Address = "789 Oak St",
                            Customer_ID = "103",
                            Datetime = new DateTime(2024, 12, 1, 20, 18, 47, 834, DateTimeKind.Local).AddTicks(6954),
                            Discount_amount = 0m,
                            OrderStatus = "Shipped",
                            Total = 250m
                        });
